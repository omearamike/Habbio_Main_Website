...
class jaxlite_customize {
	...
	public function customize_scripts() {
		...
		$jaxlite_details = array(
			...
			'url' => esc_url('https://www.themeinprogress.com/jax-free-responsive-creative-wordpress-theme/?aff=panel')
		);
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Jaxlite_Customize_Info_Control extends WP_Customize_Control {
		...
		public function render_content() { ?>
			...
			<h2><?php _e('Get support','jaxlite');?></h2> 
            
            <div class="inside">
    
                <p><?php _e("If you've opened a new support ticket from <strong>WordPress.org</strong>, please send a reminder to <strong>support@wpinprogress.com</strong>, to get a faster reply.","jaxlite");?></p>

                <ul>
                
                    <li><a class="button" href="<?php echo esc_url( 'https://wordpress.org/support/theme/jax-lite' ); ?>" title="<?php _e('Open a new ticket','jaxlite');?>" target="_blank"><?php _e('Open a new ticket','jaxlite');?></a></li>
                    <li><a class="button" href="<?php echo esc_url( 'mailto:support@wpinprogress.com' ); ?>" title="<?php _e('Send a reminder','jaxlite');?>" target="_blank"><?php _e('Send a reminder','jaxlite');?></a></li>
                
                </ul>
    

                <p><?php _e("If you like this theme and support, <strong>I'd appreciate</strong> any of the following:","jaxlite");?></p>

                <ul>
                
                    <li><a class="button" href="<?php echo esc_url( 'https://wordpress.org/support/view/theme-reviews/jax-lite#postform' ); ?>" title="<?php _e('Rate this Theme','jaxlite');?>" target="_blank"><?php _e('Rate this Theme','jaxlite');?></a></li>
                    <li><a class="button" href="<?php echo esc_url( 'https://www.facebook.com/WpInProgress' ); ?>" title="<?php _e('Like on Facebook','jaxlite');?>" target="_blank"><?php _e('Like on Facebook','jaxlite');?></a></li>
                    <li><a class="button" href="<?php echo esc_url( 'http://eepurl.com/SknoL' ); ?>" title="<?php _e('Subscribe our newsletter','jaxlite');?>" target="_blank"><?php _e('Subscribe our newsletter','jaxlite');?></a></li>
